...
const CardValueCount = ({
  ...
  return (
    <div
      className={`p-[1px] max-w-[413px] bg-gradient-to-tl from-white from-40% to-white/30 rounded-3xl ${
        className && className
      }`}
    >
      <motion.div
        className="max-w-[412px] min-h-[142px] rounded-3xl bg-[#171717] flex items-center pl-20 gap-10"
      ...
      >
        <span className="w-[54px] aspect-square rounded-full bg-white flex justify-center items-center">
          <Image src={icon} alt="icons" width={30} height={30} />
        </span>
